...
python3 /gpfs/radev/project/zhuoran_yang/sc3226/Unveiling-Induction-Heads/RPE/train_simplified.py --vocab-size 3 --seq-length 100 --n-heads 1 --n-gram 2 --w-plus 3 --c-alpha 0.01 --device cuda --n-epochs 50000   --lr 1 --train-cmd CWa --low-degree 1 --dataset Markov
