...
python3 train.py --vocab-size 3 --seq-length 100 --n-heads 3 --n-gram 3 --w-plus 2 --c-alpha 0.01 --device cuda:0 --n-epochs 2000 --lr1 1 --lr2 1  --lr3 1 --train-cmd CW --train-cmd a # works!!!
